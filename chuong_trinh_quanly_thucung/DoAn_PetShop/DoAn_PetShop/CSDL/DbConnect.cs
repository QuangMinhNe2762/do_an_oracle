...
namespace DoAn_PetShop.CSDL
{
    class DbConnect
    {
        ...
        {
            connString = @"DATA SOURCE = localhost:1521/PetShop; USER ID=" + username + ";PASSWORD=" + password + "";
        ...
        {
            connString = @"DATA SOURCE = localhost:1521/PetShop; USER ID=" + username + ";PASSWORD=" + password + ";DBA Privilege=SYSDBA";
            OracleConnection conn = new OracleConnection();
            conn.ConnectionString = connString;
            return conn;
        }
